(function () {
  ...
  const CLIENT_KEY = 'cvg_live_villagie';
  ...
  let CONFIG = {
    ...
    brandColor:   '#7B2FBE',
    greeting:     null,
    quickReplies: ["Women's fashion", "Hair & Wigs", "Jewellery", "Kids"],
  };
  ...
  function getPageContext() {
    ...
    if (path.includes('/product/'))                      return { section: 'Product page: ' + document.title };
